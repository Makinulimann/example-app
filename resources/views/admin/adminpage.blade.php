    ...
    <section id="layanan">
        <div class="container">
            <div class="row text-center">
                ...
                <div class="col-md-3 layanan" type="button" onclick="location.href='{{route('admin.checkups')}}'">
                    <img src="assets/gambar.svg" alt="" class="img-layanan">
    ...
    <section id="artikel">
        <div class="container">
            ...
            <div class="d-flex justify-content-start mb-4">
                <a href="{{ route('listArticleAdmin') }}" class="btn btn-primary">Lihat Semua</a>
                <a href="kelolaArticle" class="btn btn-primary">Kelola</a>
            </div>
            <div class="row">
